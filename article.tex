...
\begin{abstract}
  ...
  sensitive datasets poses new challenges to administrative models in which a single data administrator is responsible for the research activities of multiple analysts. To address these challenges, in this paper, we introduce two new
  abstractions: `safe-collections' and `stewardship'. This work extends \NAME to support growing and evolving
  challenges associated with computing on highly sensitive data-sets. `Safe-collections'
  is a novel abstraction that refines the scope of a data-store and the policies tied
  to it. `Stewards' are a new class of privileged user who own and manage safe-collections.
  The introduction of these novel abstractions and the associated modifications to \NAME required to accommodate them represents an attempt to
