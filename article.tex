...
sensitive datasets in science, coupled with the need for collaboration,
...
needed by researchers. Current approaches often rely on a single 
...
to it. Stewards are a class of privileged user who own and manage safe-collections.
Our aim, by introducing these abstractions, is to 
