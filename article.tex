...
\begin{abstract}
  ...
  sensitive datasets poses new challenges to administrative models in which a single data administrator is responsible for the research activities of multiple analysts. In this paper, we introduce new
